...
typedef struct
{
    CAN_TypeDef        *CANx;         /* STM32F4xx specific */
    CO_CANrx_t         *rxArray;
    uint16_t            rxSize;
    CO_CANtx_t         *txArray;
    uint16_t            txSize;
    volatile uint8_t     CANnormal;
...
/* Send CAN message. */
extern CO_ReturnError_t CO_CANsend(CO_CANmodule_t *CANmodule, CO_CANtx_t *buffer);


/* Clear all synchronous TPDOs from CAN module transmit buffers. */
extern void CO_CANclearPendingSyncPDOs(CO_CANmodule_t *CANmodule);


/* Verify all errors of CAN module. */
extern void CO_CANverifyErrors(CO_CANmodule_t *CANmodule);


/* CAN interrupts receives and transmits CAN messages. */
extern void CO_CANinterrupt_Tx(CO_CANmodule_t *CANmodule);
extern void CO_CANinterrupt_Rx(CanRxMsgTypeDef* pRxMsg, CO_CANmodule_t *CANmodule);
