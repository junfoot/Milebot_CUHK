...
typedef struct{
    ...
    CO_HBconsumer_t    *HBcons[CO_NO_CAN_MODULES];         /**<  Heartbeat consumer object*/
#if CO_NO_SDO_CLIENT == 1
...
extern void CO_CAN_TxCpltCallback(CAN_TypeDef* CANx);
extern void CO_CAN_RxCpltCallback(CAN_TypeDef* CANx, CanRxMsgTypeDef* pRxMsg);
extern uint8_t can1_flg;
extern uint8_t can2_flg;
#ifdef __cplusplus
}
#endif /*__cplusplus*/
